  ...
  "danger": {
      ...
      "github": {
        "issue": {
          ...
          "id": 167696965,
          "number": 609,
          "title": "[TEST-123] MOCK-321: TEST-123 Xcode updates no-jira",
          "user": {
            "login": "ashfurrow",
            "id": 498212,
          ...
          "body": "[TEST 123] MOCK-321 TEST-123 no-jira I don't want to spend much time on this project, but I do want to keep it up to date with current tools so that we can deploy any fixes quickly. \\n\\nI tried updating to CocoaPods 1.0, but things went quickly awry. It's a large job, but not necessary for now. \\n",
          "closed_by": {
            "login": "ashfurrow",
            "id": 498212,
            "avatar_url": "https://avatars3.githubusercontent.com/u/498212?v=4",
        ...
        "pr": {
          ...
          "body":
            "[TEST 123] MOCK-321 TEST-123 no-jira I don't want to spend much time on this project, but I do want to keep it up to date with current tools so that we can deploy any fixes quickly. \\n\\nI tried updating to CocoaPods 1.0, but things went quickly awry. It's a large job, but not necessary for now. \\n",
          "created_at": "2016-07-26T19:57:30Z",
