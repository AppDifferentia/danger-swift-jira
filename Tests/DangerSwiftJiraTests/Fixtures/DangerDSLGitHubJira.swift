  ...
  "danger": {
        ...
        "commits": [
          {
            ...
            "message": "[TEST-123 Xcode] Updates for compatibility with Xcode 7.3.1.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 CI] Updates Travis to Xcode 7.3.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 Deps] Updates dependencies for Swift 2.2.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 Tests] Cleans up snapshot tests for Xcode 7.3.1.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 Tests] Fixes typo, thanks @Gerst20051.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 Podfile] Adds comment for specific pod commit.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 CI] Fix for intermittent CI failures.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 Ruby] Adds version-specifier.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 CI] Split up failing test + switch to syncrhonous testing.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 CI] Fixes pre-launching simulator UUID.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 CI] Fixes intermittently failing test comparing dates.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 Deps] Updates dependencies to latest Swift 2.x versions.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 CI] Fixes more intermittent tests.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 CI] Removed duplicate simulator launch.",
            "tree": {
          ...
          },
          {
            ...
            "message": "[TEST-123 Feedback] Adds clarifying comments as per feedback in #609.",
            "tree": {
      ...
      "github": {
        "issue": {
          ...
          "id": 167696965,
          "number": 609,
          "title": "[TEST-123] MOCK-321: TEST-123 Xcode updates",
          "user": {
            "login": "ashfurrow",
            "id": 498212,
          ...
          "body": "[TEST 123] MOCK-321 TEST-123 I don't want to spend much time on this project, but I do want to keep it up to date with current tools so that we can deploy any fixes quickly. \\n\\nI tried updating to CocoaPods 1.0, but things went quickly awry. It's a large job, but not necessary for now. \\n",
          "closed_by": {
            "login": "ashfurrow",
            "id": 498212,
            "avatar_url": "https://avatars3.githubusercontent.com/u/498212?v=4",
        ...
        "pr": {
          ...
          "state": "closed",
          "locked": false,
          "title": "[TEST-123] MOCK-321 Xcode updates",
          "user": {
            "login": "ashfurrow",
            "id": 498212,
            "avatar_url": "https://avatars3.githubusercontent.com/u/498212?v=4",
          ...
          "body":
            "[TEST 123] MOCK-321 TEST-123 I don't want to spend much time on this project, but I do want to keep it up to date with current tools so that we can deploy any fixes quickly. \\n\\nI tried updating to CocoaPods 1.0, but things went quickly awry. It's a large job, but not necessary for now. \\n",
          "created_at": "2016-07-26T19:57:30Z",
